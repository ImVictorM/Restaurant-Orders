...
def test_dish_instantiation(bacon_and_eggs):
...
def test_dish_restrictions(bacon_and_eggs):
    bacon = Ingredient("bacon")
    egg = Ingredient("ovo")
    bacon_and_eggs.add_ingredient_dependency(bacon, 2)
    bacon_and_eggs.add_ingredient_dependency(egg, 1)
